...
type Tier = 'dominant' | 'common' | 'minor' | 'absent';

// Manual encoding of target matrix (niche label → subtype name → tier)
// Niche order: Soil×4climates, Hill×4, Wetland×4, Arid×4
...
function getTargetTier(niche: string, subtype: string): Tier {
